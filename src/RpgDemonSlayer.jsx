...
function RpgDemonSlayer() {
  ...
  function hideError() {
    ...
    document.getElementById("errorpesquisa").style.display = 'none';
    console.log("");
  }
  ...
  function handleSearch() {
    document.getElementById("errorpesquisa").innerHTML = '';
    ...
    if (busca != "") {
      ...
      habilidade.map((item) => {
        if (item.nome === busca) {
          ...
          document.getElementById("errorpesquisa").innerHTML = 'Habilidade não encontrada!';
        }
      })
    } else {
      document.getElementById("errorpesquisa").innerHTML = 'Preencha o campo com a Respiração para fazer a busca!';
    }
    ...
    <div className="App">
      ...
      <div className="forms">
        <div className="linhas">
          <p className='addRespira' onClick={showModalBusca} > Buscar Respiração </p>
        ...
        <div className="box-busca" id='modalBusca'>
          <div className="input-group">
            <input type="text" id="busca" required className="input" placeholder='Digite uma magia para Buscar!' />

            <div className="linha">
              <p className="button" onClick={handleSearch}>Buscar</p>
              <p id="errorpesquisa"></p>
            </div>
      ...
      <div className='main' >
        {habilidade.map((habilidade) => {
          return (
            <div className='box-hability' key={habilidade.nome}>
